...
export default function SubjectPage() {
    ...
    const handleCreateMaterial = (e) => {
        ...
        try {
            ...
            educationalMaterialService.createMaterial(formData)
        } catch (error) {
    ...
    return (
        <div className="p-6">
            ...
            <div className="flex flex-col gap-6">
                ...
                <SubjectSection key={material.title} title={material.title} description={material.description} originalFileName={material.originalFileName} uploadAt={material.uploadAt} fileDownloadUrl={material.fileDownloadUrl} 
                onDelete={() => {
            ...
            <Modal isOpen={isCreateMaterial} onClose={() => setIsCreateMaterial(false)} title="Создать материал">
                <form onSubmit={(e) => handleCreateMaterial(e)} className="space-y-4">
                    <div>
                        ...
                        <label className="block text-gray-700 mb-5 text-center sm:text-[14px] md:text-[16px] lg:text-[18px]">Фото материала</label>
